...
<div class="row">
    <div class="col-md-12">    
        <div class="row">
            ...
            <div class="input-field col-md-10">
                <input type="text" name="txt_plazo" id="txt_plazo" value="${requestScope['plazo']}"/>
                <label for="txt_plazo" class="${requestScope['obj_active_form']}">Plazo:</label>
            </div>   
            <div class="input-field col-md-1">        
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">
                <button onclick="sgd_mant_tramite_guardar()" class="btn btn-info btn-sm">Guardar</button>            
            </div>
            <div class="input-field col-md-1">        
            </div>
        </div>
