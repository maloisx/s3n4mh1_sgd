                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-2">
                                ...
                                <input type="hidden" name="hd_operacion" id="hd_operacion" value="1"/> 
                            </div>
                            <div class="input-field col-sm-2">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-5">
                                ...
                                <select name="cb_clsfdoc" id="cb_clsfdoc" class="form-control selectpicker" data-size="3" disabled>${requestScope['cb_clsfdoc']}</select>
                            ...
                            <div class="input-field col-sm-3">
                                <input name="txt_fec_doc" id="txt_fec_doc" type="text" class="datepicker" value="${requestScope['fec_doc']}" style="color: #000;" disabled/>
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-12">
                                <select name="cb_remite" id="cb_remite" class="form-control selectpicker" data-live-search="true" data-size="3" disabled>${requestScope['cb_remite']}</select>                                       
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="input-field col-sm-11">                                
                                ...
                                <select name="cb_destino" id="cb_destino" class="form-control selectpicker" data-live-search="true" data-size="3" onchange="sgd_mant_destino_cargar_txt(this.value,'d'); hd_iddes.value=this.value;" disabled>${requestScope['cb_destino']}</select>
...
<!--                    <div class="row input-field col-sm-5" id="div_mant_adjunto_tbl">
                ...
                <!--<div class="row form-group" >-->
                    <div class="input-field col-sm-6" style=" width:50%;">                        
                        <form enctype="multipart/form-data">
                            ...
                            <input id="file-sgd" name="file-sgd[]" type="file" multiple class="file file-loading form-control" style="height: 20%" />
                        </form>
                    </div> 
                    <div class="input-field col-sm-1"></div>
                ...
                <div class="row form-group text-right" >
                    <div class="col-sm-12" >                        
                        <button id="btn_guardar" onclick="sgd_mant_expediente_guardar()" class="btn btn-info btn-sm" disabled>
                            Guardar       
                        </button> 
