    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">                      
                ...
                <label for="cb_estado" class="${requestScope['obj_active_form']}">Seleccione el estado:</label> 
            </div>
            <div class="input-field col-md-1">        
            </div>  
        </div>  
...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10"> 
                <button onclick="sgd_mant_origen_guardar()" class="btn btn-info btn-sm">Guardar</button>      
            </div>
            <div class="input-field col-md-1">        
            </div>  
        </div>  
