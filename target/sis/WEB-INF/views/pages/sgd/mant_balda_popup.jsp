    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">                
                <select name="cb_cpo" id="cb_cpo" class="form-control selectpicker">${requestScope['cb_desc_cpo']}</select> 
                <label for="cb_cpo" class="active">Seleccione Cuerpo:</label>  
            </div>
            <div class="input-field col-md-1">        
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">
                <button onclick="sgd_mant_balda_guardar()" class="btn btn-info btn-sm">Guardar</button>            
            </div>
            <div class="input-field col-md-1">        
            </div>
        </div>
