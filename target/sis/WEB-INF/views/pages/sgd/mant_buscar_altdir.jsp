        ...
        <div class="row">
            <div class="input-field col-sm-12">        
                ...
                <div class="input-field col-sm-3">
                    <select name="cb_uo" id="cb_uo" class="form-control selectpicker" data-size="5" data-live-search="true">${requestScope['cb_uo']}</select>
                    <label for="cb_uo" class="active">Unid. Orgánica remite</label>
                </div> 
                <div class="input-field col-sm-2">       
                    <button id="btn_buscar" onclick="sgd_mant_buscar_altdir_tbl(document.getElementById('txt_cut').value,document.getElementById('cb_periodo').value,document.getElementById('txt_asun').value,document.getElementById('cb_clsdoc').value,document.getElementById('txt_nro').value,document.getElementById('cb_uo').value)" class="btn btn-info btn-sm" >
                        BUSCAR       
                    </button>
                </div>    
            </div> 
        ...
        <div class="row">
            <div class="col-sm-12">               
                ...
                <div class="row">  
                    ...
                    <div class="col-sm-10" id="div_buscar_altdir_tbl" >                     
                    </div>
                    <div class="input-field col-sm-1">        
                    </div>
                </div>      
