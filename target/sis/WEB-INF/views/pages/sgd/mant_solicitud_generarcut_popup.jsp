            ...
            <div class="tab-pane active" id="doc">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="input-field col-sm-2">
                                <input id ="txt_per" type="text" value="${requestScope['per']}" readonly  style="text-align: center; color: red; font-size:150%; font-weight:bold;"/>
                                <label for="txt_per" class="active">Periodo</label>
                            </div>
                            <div class="input-field col-sm-4">
                                <input id="txt_fecreg" type="text" value="${requestScope['fecreg']}" readonly style="text-align: center; color: red;"/>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col-sm-4">
                                <input id="txt_plazo" type="number" min="1" value="${requestScope['plazo']}" />
                        ...
                        <div class="row">
                            <div class="input-field col-sm-8">
                                <select name="cb_tema" id="cb_tema" class="form-control selectpicker" disabled>${requestScope['cb_tema']}</select>
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            ...
                            <div class="input-field col-sm-4">
                                <select name="cb_orig" id="cb_orig" class="form-control selectpicker" disabled>${requestScope['cb_origen']}</select>
                                <label for="cb_orig" class="active">Orig</label>
                            </div>
                        </div>
                        <div class="row" style="padding-top: 13px">
                            <div class="input-field col-sm-11">
                                <select name="cb_proced" id="cb_proced" class="form-control selectpicker" disabled>${requestScope['cb_proced']}</select>
                                <label for="cb_proced" class="active">Procedimiento</label>
                            </div>                            
                        </div>
                        <div class="row" style="padding-top: 13px">
                            <div class="input-field col-sm-7">
                                <input id="txt_cutext" type="text" class="text-uppercase" value="${requestScope['cutext']}" /> 
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-5">
                                ...
                                <select name="cb_clsfdoc" id="cb_clsfdoc" class="form-control selectpicker" data-live-search="true" disabled>${requestScope['cb_clsfdoc']}</select>
                                <label for="cb_clsfdoc" class="active">Tipo de documento</label>
                            </div>
                            <div class="input-field col-sm-2">
                                 <input name="txt_nrodoc" id="txt_nrodoc" type="number" min="1" value="${requestScope['nrodoc']}" ${requestScope['obj_readonly']}/>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-12">
                                <select name="cb_remite" id="cb_remite" class="form-control selectpicker" data-live-search="true" ${requestScope['obj_enabled']} disabled>${requestScope['cb_remite']}</select>                                       
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="input-field col-sm-11">
                                <select name="cb_destino" id="cb_destino" class="form-control selectpicker" data-live-search="true" data-size="6" disabled>${requestScope['cb_destino']}</select>
                                <label for="cb_destino" class="active">Destinatario: Institución/Unid.Org.</label>
                            </div>
                        </div>
                        <div class="row" style="padding-top:25px">
                            <div class="input-field col-sm-11">
                                <input required name="txt_destino" id="txt_destino" type="text" class="validate" value="${requestScope['txt_destino']}" ${requestScope['obj_readonly']}/>
...
<!--//carga el combo procedimiento-->
    ...
    $('#cb_priori option:first-child').attr('selected', 'selected');
    $('#cb_alcance option:first-child').attr('selected', 'selected');
    $('#cb_tema option:first-child').attr('selected', 'selected');
