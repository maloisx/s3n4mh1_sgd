...
function sgd_mant_expediente_guardar(modifica){
    var id = $('#hd_id').val();
    var per = $('#txt_per').val();
...
//Fin Acciones para derivación    
    ...
    $.ajax({
            ...
            data:     "id="+id+"&codUser="+codUser+"&perfil="+perfil+"&id_uo="+id_uo+"&cd_fin="+cd_fin+"&id_doc="+id_doc+"&id_flujo_ant="+id_flujo_ant+"&copia="+copia+"&nivel="+nivel+"&cb_fisico="+cb_fisico+"&rpta_r="+rpta_r+"&rpta_c="+rpta_c+"&observa="+observa,	 	 
            beforeSend: function(data){ 	 	
