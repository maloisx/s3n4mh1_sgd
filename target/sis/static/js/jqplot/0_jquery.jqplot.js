    ...
    $.jqplot.TableLegendRenderer.prototype.draw = function() {
        ...
        if (this.show) {
            ...
            var pad = false, 
				...
				s;
            ///////////////////////////////////////////////////////
            //modificado por Miguel villanueva gonzalez!!
            //////////////////////////////////////////////////////
            var series_temp = new Array(); 
            var ns_temp = 0;
            for (var i = 0; i< series.length; i++) {
            	 s = series[i];
            	var lt = s.label.toString();
            	series_temp[ns_temp] = lt;
            	ns_temp++;
            }
            
            series_temp = series_temp.sort(function (a, b) { return a*1 - b*1; });
            var ret = [series_temp[0]];
            for (var i = 1; i < series_temp.length; i++) { 
                if (series_temp[i-1] !== series_temp[i]) {
                    ret.push(series_temp[i]);
                }
            }
            
            for (var i = 0; i < ret.length; i++) { 
            	ret[i] = new Array(ret[i],0);
            }
