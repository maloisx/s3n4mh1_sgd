...
<body>    
    ...
    <% 
            ...
            //else{
                    %>					
                            <table width="100%" height="100%" border="1" cellspacing="0" cellpadding="0" style="padding: 0px; margin: 0px;">
                              <tr>
                                <td width="200px" rowspan="3" valign="top">                                    
                                    <tiles:insertAttribute name="menu" />
                                    
                                </td>
                                <td height="67px" align="center" style="background: url('<c:url value='/static/img/footer_bg_cen.jpg' />');">
                                    <tiles:insertAttribute name="header" />
                                </td>					    
                              </tr>
                              <tr valign="middle" height="0px">
                                <td align="left" id="titulopag" style="font-weight: bold;font-size: 16px;">
                                    <!-- TITULO DE PAGINA -->
                                </td>
                              </tr>
                              <tr valign="top">
                              ...
                              <!-- 
                              <tr>
                                <td height="30px" colspan="2" style="background: url('<?php echo $this->util()->getImage("footer_bg_cen.jpg"); ?>');">
