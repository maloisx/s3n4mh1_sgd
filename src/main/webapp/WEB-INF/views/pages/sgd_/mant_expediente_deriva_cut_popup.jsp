    ...
    <div class="form-control input-field col-md-12">        
        <div class="row">
            ...
            <div class="col-xs-5">  
                ...
                <select class="form-control selectpicker"  data-size="5"  name="cb_cd_ini" id="cb_cd_ini" multiple data-live-search="true" multiple data-actions-box="true" onchange="charge_list_boostrap_select('cb_cd_ini','cb_cd_fin')">${requestScope['cb_uo']}</select>
            </div>
            <div class="col-xs-5">   
                <lable for="cb_cd_fin" class="active">Unidad Orgánica Seleccionada:</lable>
                <select class="form-control selectpicker"  data-size="5"  name="cb_cd_fin" id="cb_cd_fin" multiple  data-live-search="true" data-actions-box="true" onchange="delete_cascade_list_boostrap_select('cb_cd_fin','cb_cd_ini')"></select>                    
            </div>  
            <div class="col-xs-1">        
            </div>
        </div>  
