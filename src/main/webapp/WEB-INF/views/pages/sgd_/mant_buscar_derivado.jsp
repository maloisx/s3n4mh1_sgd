...
<!--                <div class="input-field col-sm-1">   
                ...
                <div class="input-field col-sm-2">       
                    <button id="btn_guardar" onclick="sgd_mant_buscar_derivado_tbl(document.getElementById('txt_cut').value,document.getElementById('cb_periodo').value,document.getElementById('txt_asun').value,document.getElementById('cb_clsdoc').value,document.getElementById('txt_nro').value)" class="btn btn-info btn-sm" >
                        BUSCAR       
                    </button>
                </div>    
            </div> 
        ...
        <div class="row">
            <div class="col-sm-12">               
                ...
                <div class="row">  
                    ...
                    <div class="col-sm-10" id="div_buscar_derivado_tbl" >                     
                    </div>
                    <div class="input-field col-sm-1">        
                    </div>
                </div>      
