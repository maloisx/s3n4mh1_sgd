...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field col-md-10">
                <select name="cb_estado" id="cb_estado" >${requestScope['cb_estado']}</select>
                <label for="cb_estado">Seleccione el estado:</label>
            </div>
            <div class="input-field col-md-1">        
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">
                <button onclick="sgd_mant_condicion_guardar()" class="btn btn-info btn-sm">Guardar</button>            
            </div>
            <div class="input-field col-md-1">        
            </div>
        </div>
