            ...
            <div class="tab-pane active" id="doc">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="input-field col-md-2">
                                ...
                                <!--<input type="hidden" name="hd_iddoc" id="hd_iddoc" value="${requestScope['id_doc']}" />-->
                            ...
                            <div class="input-field col-md-2">
                                <input id ="txt_per" type="text" value="${requestScope['per']}" readonly/>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="input-field col-md-5">
                                ...
                                <label for="cb_clsfdoc" class="active">Tipo de documentoff</label>
                            </div>
                            <div class="input-field col-md-2">
                                 <input name="txt_nrodoc" id="txt_nrodoc" type="number" min="1" value="${requestScope['nrodoc']}" required readonly>
                                <label for="txt_nrodoc" class="${requestScope['obj_active_form']}">N°Doc.</label>
                            </div>
                            <div class="input-field col-md-3">
                                <input id="txt_fec_doc" type="text" class="datepicker" value="${requestScope['fec_doc']}" readonly>
                            ...
                            <div class="input-field col-md-2">   
                                <input name="txt_folio" id ="txt_folio" type="number" min="1" value="${requestScope['folio']}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="input-field col-md-12">
                                <select name="cb_remite" id="cb_remite" class="form-control selectpicker" data-live-search="true" data-size="3" >${requestScope['cb_remite']}</select>                                       
                                <label for="cb_remite" class="active">Remitente: Institución/Unid.Org. </label>
                            </div>
                        </div>
                        <div class="row" style="padding-top:25px">
                            <div class="input-field col-md-12">
                                <input id="txt_remite" type="text"  value="${requestScope['txt_remite']}"/>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="input-field col-md-11">                                
                                ...
                                <select name="cb_destino" id="cb_destino" class="form-control selectpicker" data-live-search="true" data-size="3" onchange="sgd_mant_destino_cargar_txt(this.value); hd_iddes.value=this.value;">${requestScope['cb_destino']}</select>
                                <label for="cb_destino" class="active">Destinatario: Institución/Unid.Org.</label>
                            </div>
                        </div>
                        <div class="row" style="padding-top:25px">
                            <div class="input-field col-md-11">
                                <input required name="txt_destino" id="txt_destino" type="text" class="validate" value="${requestScope['txt_destino']}"/>
                ...
                <div class="row">
                    <div class="input-field col-md-6">
                        <div class="row">
                            <div class="input-field col-md-12">
                                <textarea  id="txt_asunto" class="materialize-textarea text-uppercase" type="text" class="validate" maxlength="500" minlength="1" readonly>${requestScope['asunto']}</textarea>
                    ...
                    <div class="input-field col-md-5">
                        <div class="row">
                            <div class="input-field col-md-11">
                                <textarea  id="txt_obs" class="materialize-textarea text-uppercase" type="text" readonly>${requestScope['observacion']}</textarea>
...
<!--PESTANA LISTA DE DOCUMENTOS-->            
            <div class="tab-pane col-sm-11" id="div_lista_doc">
...
<!--PESTANA LISTA DE DERIVACION-->                                
            <div class="tab-pane col-sm-11" id="div_lista_deriva">
                <div class="row">
...
//$('.id_procedimiento option:first-child').attr('selected', 'selected');
//$('.id_cuerpo option[value="'+cpo+'"]').attr('selected','selected');
//id_tramite

//$(document).ready(function(){ 
//    $('#txt_cut').change(function(){
//      alert(document.getElementByI('hd_iddoc').value); 
//      $('#txt_plazo').focus();
//    });
//});
//  
