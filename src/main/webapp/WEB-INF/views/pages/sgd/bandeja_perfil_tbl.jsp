...
<div id="div_bandejas">
    <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-xs-12" id="">
                <ul class="nav nav-tabs tabs-top " role="tab">
    ...
    <div class="row">    
        ...
        <div class="col-xs-12 col-md-10" style="overflow-x:unset;">        
    ...
    <input type="hidden" name="hd_des_pfl" id="hd_des_pfl" value="${requestScope['des_pfl']}" />       
    ...
    <input type="hidden" name="hd_tmp_cut_agrupa" id="hd_tmp_cut_agrupa" value="" />  
</div>
