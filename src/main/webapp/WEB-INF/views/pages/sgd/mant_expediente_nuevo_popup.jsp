            ...
            <div class="tab-pane active" id="doc">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="input-field col-sm-4">
                                <select name="cb_priori" id="cb_priori" class="form-control selectpicker" onchange="sgd_mant_prioridad_cargar_txt()" data-size="3" >${requestScope['cb_priori']}</select>
                            ...
                            <div class="input-field col-sm-4">
                                <select name="cb_alcance" id="cb_alcance" class="form-control selectpicker" >${requestScope['cb_alcance']}</select>
                                <label for="cb_alcance" class="active">Alcance</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col-sm-8">
                                <select name="cb_tema" id="cb_tema" class="form-control selectpicker" data-size="3" >${requestScope['cb_tema']}</select>
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="input-field col-sm-4">
                                <select name="cb_tramite" id="cb_tramite" class="form-control selectpicker" onchange="sgd_mant_procedimiento_cargar_cbo();" data-size="3" >${requestScope['cb_tramite']}</select>
                        ...
                        <div class="row" style="padding-top: 13px">
                            <div class="input-field col-sm-11">
                                <select name="cb_procedimiento" id="cb_procedimiento" class="form-control selectpicker" data-size="3" >${requestScope['cb_procedimiento']}</select>
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-5">
                                ...
                                <select name="cb_clsfdoc" id="cb_clsfdoc" class="form-control selectpicker" data-size="4" data-live-search="true">${requestScope['cb_clsfdoc']}</select>
