                    ...
                    <div class="input-field col-sm-6">
                        <div class="row">
                            <div class="input-field col-sm-12">
                                ...
                                <label for="txt_obsmodifica" class="active" style="color: red; font-weight:bold;">Razón de la Modificación</label>
                            </div>
                        </div>  
                    </div>                     
                </div>
...
<!--                    <div class="row input-field col-sm-5" id="div_mant_adjunto_tbl">
                ...
                <div class="row form-group text-right" >
                    <div class="col-sm-12" >                        
                        <button id="btn_guardar" onclick="sgd_mant_expediente_guardar()" class="btn btn-info btn-sm" ${requestScope['obj_disabled_form']}>
                            Guardar       
                        </button> 
