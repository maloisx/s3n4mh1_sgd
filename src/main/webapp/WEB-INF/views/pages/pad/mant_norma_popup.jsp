    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">
                <input type="text" name="txt_n_norma" id="txt_n_norma" value="${requestScope['n_norma']}" />
                <label for="txt_n_norma" class="active">N° Norma/Reglamento:</label>
            </div>        
...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="input-field text-right col-md-10">
                <button onclick="pad_mant_norma_guardar()" class="btn btn-info btn-sm">Guardar</button>            
            </div>
            <div class="input-field col-md-1">        
            </div>  
        </div>  
